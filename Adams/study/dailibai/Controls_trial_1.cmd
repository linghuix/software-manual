...
data_element attributes  &
   data_element_name = .MODEL_1.theta_up  &
   visibility = off
!
data_element create variable  &
...
!
data_element attributes  &
   data_element_name = .MODEL_1.theta_down  &
   visibility = off
!
data_element create variable  &
...
!
data_element attributes  &
   data_element_name = .MODEL_1.speedtheta_down  &
   visibility = off
!
data_element create variable  &
...
!
data_element attributes  &
   data_element_name = .MODEL_1.speedtheta_up  &
   visibility = off
!
data_element create variable  &
...
!
data_element attributes  &
   data_element_name = .MODEL_1.speed  &
   visibility = off
!
data_element create variable  &
...
!
data_element attributes  &
   data_element_name = .MODEL_1.PINPUT_F  &
   visibility = off
!
...
!
data_element attributes  &
   data_element_name = .MODEL_1.POUTPUT_1  &
   visibility = off
!
!--------------------------------- Materials ----------------------------------!
!
...
marker create  &
   ...
   adams_id = 17  &
   location = 57.9894996972, 7.5, 34.29515846  &
...
!
file parasolid read  &
   file_name = "Controls_trial_1.xmt_txt"  &
   model_name = .MODEL_1
!
geometry attributes  &
...
simulation script create  &
   ...
   commands =   &
              "simulation single_run transient type=auto_select initial_static=no end_time=20.0 number_of_steps=1000 model_name=.MODEL_1"
!
...
!
variable modify  &
   variable_name = .MODEL_1.trial.input_channels  &
   object_value = .MODEL_1.a
!
variable modify  &
   variable_name = .MODEL_1.trial.output_channels  &
   object_value =   &
      .MODEL_1.speed,  &
      .MODEL_1.speedtheta_down,  &
      .MODEL_1.speedtheta_up,  &
...
!
variable modify  &
   variable_name = .MODEL_1.trial.file_name  &
   string_value = "Controls_trial_1"
!
variable modify  &
   variable_name = .MODEL_1.trial.solver_type  &
   string_value = "cplusplus"
!
variable modify  &
   variable_name = .MODEL_1.trial.target  &
   string_value = "MATLAB"
!
variable modify  &
   variable_name = .MODEL_1.trial.analysis_type  &
   string_value = "non_linear"
!
variable modify  &
   variable_name = .MODEL_1.trial.analysis_init  &
   string_value = "no"
!
variable modify  &
   variable_name = .MODEL_1.trial.analysis_init_str  &
   string_value = ""
!
variable modify  &
   variable_name = .MODEL_1.trial.user_lib  &
   string_value = ""
!
variable modify  &
   variable_name = .MODEL_1.trial.host  &
   string_value = "Power-LJR"
!
variable modify  &
   variable_name = .MODEL_1.trial.dynamic_state  &
   string_value = "on"
!
variable modify  &
   variable_name = .MODEL_1.trial.tcp_ip  &
   string_value = "off"
!
variable modify  &
   variable_name = .MODEL_1.trial.output_rate  &
   integer_value = 1
!
variable modify  &
   variable_name = .MODEL_1.trial.realtime  &
   string_value = "off"
!
variable modify  &
   variable_name = .MODEL_1.trial.include_mnf  &
   string_value = "no"
!
ude modify instance  &
   instance_name = .MODEL_1.trial
...
data_element modify variable  &
   variable_name = .MODEL_1.theta_up  &
   function = "AX(.MODEL_1.link_xia_2_daolibai_2_body1.cm,.MODEL_1.ground.MARKER_17)"
!
data_element modify variable  &
   variable_name = .MODEL_1.theta_down  &
   function = "AX( .MODEL_1.ground.MARKER_17,.MODEL_1.link_xia_1_daolibai_2_body1.cm)"
!
data_element modify variable  &
   variable_name = .MODEL_1.x  &
   function = "DZ( .MODEL_1.dizuo_1_daolibai_1_body1.MARKER_2,.MODEL_1.ground.MARKER_1,.MODEL_1.ground.MARKER_1)"
!
data_element modify variable  &
   variable_name = .MODEL_1.speedtheta_down  &
   function = "WX( .MODEL_1.ground.MARKER_17,.MODEL_1.link_xia_1_daolibai_2_body1.cm)"
!
data_element modify variable  &
   variable_name = .MODEL_1.speedtheta_up  &
   function = "WX(.MODEL_1.link_xia_2_daolibai_2_body1.cm,.MODEL_1.ground.MARKER_17)"
!
data_element modify variable  &
   variable_name = .MODEL_1.speed  &
