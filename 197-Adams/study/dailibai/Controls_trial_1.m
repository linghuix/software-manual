...
ADAMS_cwd ='F:\adam\study'  ;
ADAMS_prefix = 'Controls_trial_1' ;
ADAMS_static = 'no' ;
ADAMS_solver_type = 'C++' ;
...
ADAMS_init = '' ;
ADAMS_inputs  = 'a' ;
ADAMS_outputs = 'speed!speedtheta_down!speedtheta_up!theta_down!theta_up!x' ;
ADAMS_pinput = 'trial.ctrl_pinput' ;
ADAMS_poutput = 'trial.ctrl_poutput' ;
ADAMS_uy_ids  = [
                   7
                   6
                   4
